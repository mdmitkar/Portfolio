        ...
        <div className="w-full h-full bg-[#525659] flex flex-col">
            <div className="h-12 bg-[#323639] flex items-center justify-between px-4 shadow-md z-10 shrink-0">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <a href="/MDRESUME.pdf" download="MDRESUME.pdf" className="bg-blue-600 hover:bg-blue-500 text-white text-xs px-3 py-1.5 rounded transition-colors shadow">
                        Download
                    </a>
                </div>
            </div>
            <iframe
                src="/MDRESUME.pdf#toolbar=0"
